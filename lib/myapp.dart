      ...
      child: Scaffold(
        ...
        body: BottomBar(
          ...
          body: (context, controller) => TabBarView(
            ...
            children: [
              MyHomePage(controller: controller, color: colors[0]),
              Category(controller: controller, color: colors[1]),
              LiveWallCategory(controller: controller, color: colors[2]),
              FavoriteImagesPage(controller: controller, color: colors[3]),
            ],
          ),
        ),
      ),
